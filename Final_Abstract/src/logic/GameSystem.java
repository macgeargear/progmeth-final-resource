...
public class GameSystem {
	...
	//Fill your code here
		if (piece instanceof MotherShip) {
			if (attack) {
				Position atkPos = ((MotherShip) piece).attackTargetPosition(actionPattern);
				this.removeOtherPieces(piece, atkPos);
			} else {
				piece.move(actionPattern);
			}
		} else {
			Position atkPos = piece.attackTargetPosition(actionPattern);
			if (this.removeOtherPieces(piece, atkPos)) {
